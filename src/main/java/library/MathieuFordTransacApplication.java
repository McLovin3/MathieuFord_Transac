...
public class MathieuFordTransacApplication implements CommandLineRunner
{
    ...
    public void run(String... args) throws Exception
    {
        ...
        attendantService.createBook(new DocumentDTO(0, "20 thousand leagues under the sea", "Jules Vernes", "NOVEL", "Pierre-Jules Hetzel", 300, 1870, 2, "BOOK", 0));
        attendantService.createBook(new DocumentDTO(0, "Clean Code", "Robert Martin", "study", "Robert C. Martin", 200, 2008,2, "BOOK", 0));
